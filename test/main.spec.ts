...
let xml2jsonDisassemblerHandler: XmlToJson5Disassembler;
let json2xmlReassemblerHandler: Json5ToXmlReassembler;

describe("main function", () => {
  beforeAll(async () => {
    await copy(baselineDir, mockDir, { overwrite: true });
    xml2jsonDisassemblerHandler = new XmlToJson5Disassembler();
    json2xmlReassemblerHandler = new Json5ToXmlReassembler();
  });
